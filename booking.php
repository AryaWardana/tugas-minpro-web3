...
<div class="row justify-content-center">
    ...
    <div class="card">
            <div class="card-body py-4">
                <h4 class="pageTitle">Harap isi semua bidang yang wajib diisi</h4>
            ...
            <div class="card-footer">
                <div class="col-lg-4 col-md-6 col-sm-10 col-12 mx-auto">
                    <button class="btn btn-primary btn-sm w-100" form="book-form"><i class="bi bi-send"></i>Pesan sekarang</button>
                </div>
            </div>
        </div>
    </div>
